...
public class RotateCameraRightAction extends AbstractInputAction{
	...
	public RotateCameraRightAction(MyGame g) {
	...
	public void performAction(float time, Event e) {
			...
			if(myGame.camera.getMode() =='n') {
		       ...
		       //Console output
		       System.out.println("Rotate Camera Right Action riding on dolphin");       
		       ...
		       //Console Output
		       System.out.println("Rotate Camera Right Action off the dolphin");  
